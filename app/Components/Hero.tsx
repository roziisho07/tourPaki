  ...
  return (
    <div className="bg-white">
        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Tous Pakistan</span>
              {/* <Image
                width={100}
                height={100}
                alt="logo of company"
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <div
          aria-hidden="true"
          className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-sm sm:-top-80 bg-my_bg_image h-[972px]"
        >
          <div
            style={{
              clipPath:
